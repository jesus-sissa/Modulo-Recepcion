...
Public Class rpt_DespachoProv
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Recepcion.rpt_DespachoProv.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_DespachoProv
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_DespachoProv = New rpt_DespachoProv()
        rpt.Site = Me.Site
        Return rpt
    End Function
