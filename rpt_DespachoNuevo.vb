...
Public Class rpt_DespachoNuevo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Recepcion.rpt_DespachoNuevo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_DespachoNuevo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_DespachoNuevo = New rpt_DespachoNuevo()
        rpt.Site = Me.Site
        Return rpt
    End Function
