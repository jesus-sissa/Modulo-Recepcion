...
#Region "Metodos"
    ...
    Public Sub Actualizar()
        If StoredProcedure = "" Then MsgBox("Hay que asignar la propiedad stored procedure al elemento " & Me.Name, MsgBoxStyle.Critical, frm_MENU.Text)
        Tbl = CreaTabla()
...
#Region "Eventos Manejados"
    ...
    Private Sub cp_cmb_SimpleFiltrado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.SelectedIndexChanged
        If Filtro Is Nothing Then Exit Sub
