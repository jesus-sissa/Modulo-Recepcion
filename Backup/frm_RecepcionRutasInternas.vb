...
Public Class frm_RecepcionRutasInternas
    ...
    Private Sub Btn_RBoveda_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btn_RBoveda.Click
        SegundosDesconexion = 0
        ...
        End If
        With Lsv_Materiales
            cn_Recepcion.fn_RecRutasPropiasMateriales(.SelectedItems(0).Tag, .SelectedItems(0).SubItems(1).Text, .SelectedItems(0).SubItems(3).Text)
    ...
    Private Sub Lsv_Materiales_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Lsv_Materiales.SelectedIndexChanged
        SegundosDesconexion = 0
        If Lsv_Materiales.SelectedItems.Count > 0 Then
            If Lsv_Materiales.SelectedItems(0).SubItems(2).Text = "EN RUTA" Then
                Btn_RBoveda.Enabled = True
            Else
                Btn_RBoveda.Enabled = False
            End If
        End If
    End Sub
    ...
    Private Sub Lsv_Atms_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Lsv_Atms.SelectedIndexChanged
        ...
        If Lsv_Atms.SelectedItems(0).SubItems(8).Text = "A" Or Lsv_Atms.SelectedItems(0).SubItems(8).Text = "CA" Then
            ...
            Else
                Btn_RBovedaAtms.Enabled = False
            End If
        ElseIf Lsv_Atms.SelectedItems(0).SubItems(8).Text = "DO" Or Lsv_Atms.SelectedItems(0).SubItems(8).Text = "DC" Or _
