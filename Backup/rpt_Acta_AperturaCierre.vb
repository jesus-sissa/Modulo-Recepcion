...
Public Class rpt_Acta_AperturaCierre
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_Acta_AperturaCierre.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Recepcion.rpt_Acta_AperturaCierre.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property ProxApertura() As CrystalDecisions.CrystalReports.Engine.Section
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Remisiones() As CrystalDecisions.CrystalReports.Engine.Section
        Get
...
Public Class Cachedrpt_Acta_AperturaCierre
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Acta_AperturaCierre = New rpt_Acta_AperturaCierre
        rpt.Site = Me.Site
        Return rpt
    End Function
