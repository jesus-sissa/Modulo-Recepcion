...
#Region "Recepcion Rutas Externas"
    ...
    Public Shared Function fn_RecRutasExternas_Nuevo(ByVal NumeroRemision As Long, ByVal Envases As Integer,
                                                     ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
                                                     ByVal IdCia As Integer, ByVal BovedaID As Integer, ByVal ClienteP As Integer,
...
#Region "Recepcion Rutas Propias"
    ...
    End Function
    Public Shared Function fn_ReRutasPropiasLlenaListaRemisionesMateriales(ByRef lsv As ListView, ByVal Indice As Integer) As Boolean
        fn_LlenarListaD("Mat_puntosRemisiones_GetD", "id_Punto", lsv, Indice)
    End Function
    ...
    Public Shared Function fn_RecRutasPropiasMateriales(ByVal Id_Programacion As Integer, Id_Punto As Integer) As Boolean
        Dim Cnn As SqlClient.SqlConnection = Cn_Datos.Crea_ConexionSTD
        ...
        Try
            ...
            Cmd = Cn_Datos.Crea_ComandoT(Cnn, lc_Transaccion, CommandType.StoredProcedure, "Mat_Ventas_StatusRR")
            Cn_Datos.Crea_Parametro(Cmd, "@Id_Programacion", SqlDbType.Int, Id_Programacion)
            Cn_Datos.Crea_Parametro(Cmd, "@Id_Punto", SqlDbType.Int, Id_Punto)
            Cn_Datos.Crea_Parametro(Cmd, "@Id_UsuarioValida", SqlDbType.Int, UsuarioId)
            Cn_Datos.EjecutarNonQueryT(Cmd)
    ...
    Public Shared Function fn_RecRutasPropias_Update(ByVal Id_Remision As Integer, ByVal NumeroRemision As Long,
                                                    ByVal Envases As Integer, ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
                                                    ByVal Id_Punto As Integer, ByVal dt As DataTable, ByVal lsv As ListView,
        ...
        Cn_Datos.Crea_Parametro(Cmd, "@Id_Usurio", SqlDbType.Int, UsuarioId) 'varchar(5)
        Try
    ...
    Public Shared Function fn_RecRutasPropias_Create(ByVal NumeroRemision As Long,
                                                   ByVal Envases As Integer, ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
...
SiguientePunto:
    ...
    Public Shared Function fn_RecRutasPropiasRemanentesAtms(ByVal NumeroRemision As Long, ByVal ProgramacionID As Integer,
                                                   ByVal Envases As Integer, ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
                                                   ByVal Id_PuntoC As Integer, ByVal DotacionId As Integer, ByVal dt As DataTable, ByVal lsv As ListView,
    ...
    Public Shared Function fn_RecRutasPropiasAtmsRemanentes_Update(ByVal Id_Remision As Integer, ByVal NumeroRemision As Long,
                                                    ByVal Envases As Integer, ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
                                                    ByVal Id_PuntoC As Integer, ByVal dt As DataTable, ByVal lsv As ListView, ByVal DotacionId As Integer,
                                                    ByVal BovedaID As Integer, ByVal EntidadDestino As Integer, ByVal EntidadOrigen As Integer) As Boolean
        'Aqui se inserta un nuevo registro
        Dim Cnn As SqlClient.SqlConnection = Cn_Datos.Crea_ConexionSTD
        Dim lc_Transaccion As SqlClient.SqlTransaction
    ...
    Public Shared Function fn_RecRutasPropiasCustodiaAtmsFallas(ByVal NumeroRemision As Long, ByVal ProgramacionID As Integer,
                                                   ByVal Envases As Integer, ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
                                                   ByVal Id_Falla As Integer, ByVal dt As DataTable, ByVal lsv As ListView,
                                                   ByVal BovedaID As Integer, ByVal EntidadDestino As Integer, ByVal EntidadOrigen As Integer) As Boolean
    ...
    Public Shared Function fn_RecRutasPropiasCustodiaAtmsFallas_Update(ByVal Id_Remision As Integer, ByVal NumeroRemision As Long,
                                                    ByVal Envases As Integer, ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
                                                    ByVal Id_Falla As Integer, ByVal dt As DataTable, ByVal lsv As ListView,
                                                    ByVal BovedaID As Integer, ByVal EntidadDestino As Integer, ByVal EntidadOrigen As Integer) As Boolean
        'Aqui se inserta un nuevo registro
    ...
    Public Shared Function fn_RecRutasPropiasAtms_Update(ByVal Id_Remision As Integer, ByVal NumeroRemision As Long,
                                                    ByVal Envases As Integer, ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
...
#Region "Recepcion de Custodias ATMs"
    ...
    Public Shared Function fn_RecepcionCustodiasATMs_Guardar(ByVal NumeroRemision As Long, ByVal Envases As Integer,
                                                     ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
                                                     ByVal IdCia As Integer, ByVal BovedaID As Integer, ByVal Cajero As Integer,
    ...
    Public Shared Function fn_MovIntCustodias_Guardar(ByVal NumeroRemision As Long, ByVal Envases As Integer,
                                                     ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
                                                     ByVal IdCia As Integer, ByVal BovedaID As Integer, ByVal Destino As Integer,
...
#Region "Consulta Saldos"
    ...
    Public Shared Function fn_ConsultaSaldo_GuardarRemisionReemplazo(ByVal Id_RemisionAnterior As Integer, ByVal RemisionReemplazo As Long, ByVal Envases As Integer,
...
#Region "Asignar Fecha y Ruta a Servicios"
    ...
    Public Shared Function fn_Servicios_ActualizarTipos(ByVal lsv As cp_Listview, ByVal Tipo As Integer, ByVal TipoP As Integer, ByVal DotacionPro As Char,
                                                        ByVal DotacionMor As Char, ByVal DotacionATM As Char, ByVal Material As Char, ByVal ConcentracionATM As Char,
...
#Region "Despacho Propias"
    ...
    Public Shared Function fn_DespachoPropias_Create(ByVal lsv As cp_Listview, ByVal Ruta As Integer, ByVal CantidadRemisiones As Integer, ByVal CantidadEnvases As Integer, ByVal ImporteT As Decimal, ByVal str_Ruta As String, ByVal str_Fecha As String, ByVal Id_Programacion As Integer) As Boolean
        ...
        Dim lis_puntos As New List(Of Cls_Puntos)
        ...
        Try
            ...
            For Each Elemento In lsv.CheckedItems
                ...
                Cn_Datos.Crea_Parametro(Cmd, "@Ruta_Salida", SqlDbType.Int, Ruta)
                Cn_Datos.Crea_Parametro(Cmd, "@Nombre_Destino", SqlDbType.VarChar, Elemento.SubItems(2).Text)
                Cn_Datos.Crea_Parametro(Cmd, "@Nombre_Origen", SqlDbType.VarChar, Elemento.SubItems(1).Text)
                Cn_Datos.EjecutarNonQueryT(Cmd)
...
Cancelar:
            ...
            For Each Elemento In lsv.CheckedItems
                ...
                'Author :JROO 
                'Date   :13/12/2022
                'Descrip: Se agrega esta validadcion para comprbar que los puntos se crearon correctamente.
                ''************************************************************************************************************************
                'If Id_punto <= 0 Then
                'If Not fn_Tv_Existe_Punto(Cnn, Cmd, lc_Transaccion, Id_punto) Then
                '    lc_Transaccion.Rollback()
                '    Cnn.Close()
                '    GoTo Cancelar
                'End If
                lis_puntos.Add(New Cls_Puntos() With {
                                                        .Id_punto = Id_punto,
                                                        .Id_Remision = CInt(Elemento.SubItems(7).Text)})
                ''************************************************************************************************************************
                'Insertar la Remision
                ...
                If Dt_Dotacion.Rows.Count > 0 Then
                    ...
                    If Dt_Datos.Rows.Count > 0 Then
                        ...
                        'Author  :JROO
                        'Date    :13/12/2022    
                        'Descrip :Se agrega la validacion para que en los movimientos de facturacion se cree un movimiento para cada punto del cliente 
                        'CARNES RAMOS PLATON SANCHEZ ID:3146
                        ''********************************************************************************************************************************
                        If Movimiento_Existente AndAlso CInt(Dt_Datos(0)("Id_Cliente").ToString()) = 3146 Then
                            Excep = True
                        End If
                        ''********************************************************************************************************************************
                        ...
                        If ((CInt(Dt_Datos(0)("Id_Cliente")) <> Cliente_Anterior) Or Excep) And (Movimiento_Existente = False Or Excep) Then
            ...
            'Se cambia de lugar para que se actualize al finalizar los puntos
        ...
        lc_Transaccion.Commit()
        Cnn.Close()
        'comprobar que los puntos existan, en caso de que no cancelar despacho
        For Each punto As Cls_Puntos In lis_puntos
            If Not fn_Existe_Punto(punto.Id_punto, punto.Id_Remision) Then
                Cmd = Cn_Datos.Crea_Comando("Bo_Despacho_Reversa", CommandType.StoredProcedure, Crea_ConexionSTD)
                Crea_Parametro(Cmd, "@Id_Despacho", SqlDbType.Int, Id_Despacho)
                Crea_Parametro(Cmd, "@Usuario_Cancela", SqlDbType.Int, UsuarioId)
                Crea_Parametro(Cmd, "@Estacion_Cancela", SqlDbType.VarChar, EstacioN)
        ...
        Cmd = Cn_Datos.Crea_Comando("Bo_Depacho_UpdatePendiente", CommandType.StoredProcedure, Crea_ConexionSTD)
        Crea_Parametro(Cmd, "@Id_Despacho", SqlDbType.Int, Id_Despacho)
        Crea_Parametro(Cmd, "@Pendiente", SqlDbType.VarChar, "N")
        Cn_Datos.EjecutarNonQuery(Cmd)
        ...
        Return True
    End Function
    Public Shared Function fn_Existe_Punto(ByVal Id_Punto As Integer, ByVal Id_Remision As Integer) As Boolean
        Dim Cmd As SqlClient.SqlCommand
        Cmd = Cn_Datos.Crea_Comando("Tv_Existe_Punto_Remision", CommandType.StoredProcedure, Crea_ConexionSTD)
        Cn_Datos.Crea_Parametro(Cmd, "@Id_Punto", SqlDbType.Int, Id_Punto)
        Cn_Datos.Crea_Parametro(Cmd, "@Id_Remision", SqlDbType.Int, Id_Remision)
        Dim result As Boolean
        result = Cn_Datos.EjecutaConsulta(Cmd).Rows(0)(0)
        If result Then
            Return True
        Else
            Return False
    ...
    End Function
    Public Shared Function fn_Tv_Existe_Punto(ByVal cnn As SqlConnection, ByVal Cmd As SqlCommand, ByVal lc_Transaccion As SqlTransaction, ByVal Id_Punto As Integer) As Boolean
        Cmd = Cn_Datos.Crea_ComandoT(cnn, lc_Transaccion, CommandType.StoredProcedure, "Tv_Existe_Punto")
        Cn_Datos.Crea_Parametro(Cmd, "@Id_Punto", SqlDbType.Int, Id_Punto)
        Dim result As Integer = 0
        result = Cn_Datos.EjecutarScalarT(Cmd)
        If result >= 1 Then
            Return True
        Else
            Return False
    ...
    Public Shared Function fn_DespachoAtms_Create(ByVal lsv As cp_Listview, ByVal Ruta As Integer, ByVal CantidadRemisiones As Integer, ByVal CantidadEnvases As Integer, ByVal ImporteT As Decimal, ByVal str_Fecha As String, ByVal str_Ruta As String) As Boolean
        ...
        Dim Id_Despacho As Integer = 0
        Dim Id_punto_Atm As Integer = 0
        lc_Transaccion = Cn_Datos.crear_Trans(Cnn)
        Dim list_PuntosATM As New List(Of Cls_Puntos)
        Try
...
Cancelar:
            ...
            For Each Elemento In lsv.CheckedItems
                ...
                Cn_Datos.Crea_Parametro(Cmd, "@Id_Despacho", SqlDbType.Int, Id_Despacho)
                Id_punto_Atm = Cn_Datos.EjecutarScalarT(Cmd)

                'Author  :JROO 
                'Date    :13/12/2022
                'Descrip :Se agrega esta validadcion para comprbar que los puntos se crearon correctamente.
                ''****************************************************************************************************
                'If Id_punto_Atm <= 0 Then 
                'If Not fn_Atm_Existe_Punto(Cnn, Cmd, lc_Transaccion, Id_punto_Atm) Then
                '    lc_Transaccion.Rollback()
                '    Cnn.Close()
                '    GoTo Cancelar
                'End If
                list_PuntosATM.Add(New Cls_Puntos() With {
                                   .Id_punto = Id_punto_Atm,
                                   .Id_Remision = CInt(Elemento.SubItems(8).Text)
                })
                ''****************************************************************************************************
                'Actualizo Boveda
                Cmd = Cn_Datos.Crea_ComandoT(Cnn, lc_Transaccion, CommandType.StoredProcedure, "Bo_BovedaStatusSalida_Update")
            ...
            'Actualizar el Despacho (19/04/2012 JNR)
            'Se actualiza el campo Pendiente 
            'Se mueve para que actualize al finalizar los puntos
            'Cmd = Crea_ComandoT(Cnn, lc_Transaccion, CommandType.StoredProcedure, "Bo_Depacho_UpdatePendiente")
            'Crea_Parametro(Cmd, "@Id_Despacho", SqlDbType.Int, Id_Despacho)
            'Crea_Parametro(Cmd, "@Pendiente", SqlDbType.VarChar, "N")
            'EjecutarNonQueryT(Cmd)
        ...
        'comprueba que los puntos existan
        For Each punto As Cls_Puntos In list_PuntosATM
            If Not fn_Atm_Existe_Punto(Cnn, Cmd, punto.Id_punto) Then
                Cmd = Cn_Datos.Crea_Comando("Bo_Despacho_Reversa", CommandType.StoredProcedure, Crea_ConexionSTD)
                Crea_Parametro(Cmd, "@Id_Despacho", SqlDbType.Int, Id_Despacho)
                Crea_Parametro(Cmd, "@Usuario_Cancela", SqlDbType.Int, UsuarioId)
                Crea_Parametro(Cmd, "@Estacion_Cancela", SqlDbType.VarChar, EstacioN)
    ...
    End Function
    Public Shared Function fn_Atm_Existe_Punto(ByVal cnn As SqlConnection, ByVal Cmd As SqlCommand, ByVal Id_Punto As Integer) As Boolean
        Cmd = Cn_Datos.Crea_Comando("Atm_Existe_Punto", CommandType.StoredProcedure, cnn)
        Cn_Datos.Crea_Parametro(Cmd, "@Id_Punto", SqlDbType.Int, Id_Punto)
        Dim result As Integer = 0
        result = Cn_Datos.EjecutarScalarT(Cmd)
        If result >= 1 Then
    ...
    Public Shared Function fn_DespachoMateriales_Create(ByVal lsv As cp_Listview, ByVal Ruta As Integer, ByVal CantidadRemisiones As Integer, ByVal CantidadEnvases As Integer, ByVal ImporteT As Decimal, ByVal str_Fecha As String, ByVal str_Ruta As String, ID_Programacion As Integer) As Boolean
...
Cancelar:
            ...
            For Each Elemento In lsv.CheckedItems
                ...
                Cmd = Cn_Datos.Crea_ComandoT(Cnn, lc_Transaccion, CommandType.StoredProcedure, "Mat_IdPunto_Create")
                Cn_Datos.Crea_Parametro(Cmd, "@Id_venta", SqlDbType.VarChar, Elemento.SubItems(9).Text)
                Cn_Datos.Crea_Parametro(Cmd, "@Id_CS", SqlDbType.Int, 0)
                Cn_Datos.Crea_Parametro(Cmd, "@Id_Programacion", SqlDbType.VarChar, ID_Programacion)
                Cn_Datos.Crea_Parametro(Cmd, "@Id_UsuarioRegistro", SqlDbType.Int, UsuarioId)
                Cn_Datos.Crea_Parametro(Cmd, "@Id_Remision", SqlDbType.Int, Elemento.SubItems(7).Text)
                Cn_Datos.Crea_Parametro(Cmd, "@Importe", SqlDbType.Money, 0)
                Cn_Datos.Crea_Parametro(Cmd, "@EsDigital", SqlDbType.VarChar, "N")
                Cn_Datos.Crea_Parametro(Cmd, "@Cliente_Origen", SqlDbType.Int, Elemento.SubItems(7).Text)
                Cn_Datos.Crea_Parametro(Cmd, "@Cliente_Destino", SqlDbType.Int, Elemento.SubItems(7).Text)

                Id_Punto = Cn_Datos.EjecutarScalarT(Cmd)

                'Insertar la Remision

                Cmd = Cn_Datos.Crea_ComandoT(Cnn, lc_Transaccion, CommandType.StoredProcedure, "Mat_PuntosRemisiones_Create")
                Cn_Datos.Crea_Parametro(Cmd, "@Id_Punto", SqlDbType.Int, Id_punto)
                Cn_Datos.Crea_Parametro(Cmd, "@Id_Remision", SqlDbType.Int, Elemento.SubItems(7).Text)
                Cn_Datos.Crea_Parametro(Cmd, "@Usuario_Registro", SqlDbType.Int, UsuarioId)
                Cn_Datos.Crea_Parametro(Cmd, "@Id_Despacho", SqlDbType.Int, lc_identity)
                ...
                'Se actualiza en Mat_ventas y se ponen en status 'RU' y se le relaciona con un Id_Punto
    ...
    Public Shared Function fn_AsignarProceso_Guardar_Nuevo(ByVal lsv As ListView, ByVal CantidadRemisiones As Integer, ByVal CantidadEnvases As Integer, ByVal Destino As Char) As Boolean
        ...
        Try
            ...
            For Each Elemento In lsv.CheckedItems
                ...
                'Cmd = Cn_Datos.Crea_ComandoT(Cnn, lc_Transaccion, CommandType.StoredProcedure, "Cat_Movimientos_Reset")
                'Cn_Datos.Crea_Parametro(Cmd, "@Id_Remision", SqlDbType.Int, Elemento.SubItems(6).Text)
                'Cn_Datos.EjecutarNonQueryT(Cmd)
            Next
...
#Region "Parametros Locales"
    ...
    Public Shared Function fn_Locales_Actualizar(ByVal Gerente As Integer, ByVal RProceso As Decimal, ByVal RRuta As Decimal, ByVal Morralla As Char,
...
Validar:
    ...
    Public Shared Function fn_Unidades_Nuevo(ByVal Clave As String, ByVal Descripcion As String, ByVal Marca As Integer,
    ...
    Public Shared Function fn_Unidades_Actualizar(ByVal Id As Integer, ByVal Clave As String, ByVal Descripcion As String,
                                                  ByVal Marca As Integer, ByVal Modelo As Integer, ByVal NumeroContable As String,
...
#Region "Apertura Cierre de Bovedas"
    ...
    Public Shared Function fn_Bovedas_Nuevo(ByVal Clave As String, ByVal Descripcion As String, ByVal Apertura As String,
    ...
    Public Shared Function fn_Bovedas_Actualizar(ByVal Id As Integer, ByVal Clave As String, ByVal Descripcion As String, ByVal Apertura As String,
                                             ByVal Cierre As String, ByVal MonedaLR As Integer, ByVal ImporteLR _
                                             As Integer) As Boolean
...
Validar:
    ...
    Public Shared Function fn_Dispositivos_Nuevo(ByVal Clave As String, ByVal Marca As String, ByVal Modelo As String,
    ...
    Public Shared Function fn_Dispositivos_Actualizar(ByVal Id As Integer, ByVal Clave As String, ByVal Marca As String, ByVal Modelo As String,
                                             ByVal Serie As String, ByVal Observaciones As String) As Boolean
        ...
        Try
            ...
            For Each ElementoH In lsvH.CheckedItems
                ...
                For Each dr_detalle In dt.Rows
                    ...
                    Cmd = Cn_Datos.Crea_ComandoT(Cnn, lc_Transaccion, CommandType.StoredProcedure, "BO_Boveda_Create_Mat")
                    Cn_Datos.Crea_Parametro(Cmd, "@Id_Sucursal", SqlDbType.Int, SucursalId)
                    Cn_Datos.Crea_Parametro(Cmd, "@Id_Boveda", SqlDbType.Int, BovedaID)
                    Cn_Datos.Crea_Parametro(Cmd, "@Tipo", SqlDbType.Int, 1)
                    Cn_Datos.Crea_Parametro(Cmd, "@Entidad_Origen", SqlDbType.Int, 974)
                    Cn_Datos.Crea_Parametro(Cmd, "@Entidad_Destino", SqlDbType.Int, dr_detalle(9))
                    Cn_Datos.Crea_Parametro(Cmd, "@TipoP", SqlDbType.Int, 0)
                    Cn_Datos.Crea_Parametro(Cmd, "@Id_TurnoEntrada", SqlDbType.Int, TurnoId)
                    Cn_Datos.Crea_Parametro(Cmd, "@Usuario_Registro", SqlDbType.Int, UsuarioId)
                    Cn_Datos.Crea_Parametro(Cmd, "@Id_Remision", SqlDbType.Int, dr_detalle(8))
                    Cn_Datos.Crea_Parametro(Cmd, "@Ruta_Entrada", SqlDbType.Int, Rutas)
                    Cn_Datos.Crea_Parametro(Cmd, "@Ruta_Salida", SqlDbType.Int, 0)
                    Cn_Datos.Crea_Parametro(Cmd, "@Horario_Entrega", SqlDbType.VarChar, "")
                    Cn_Datos.Crea_Parametro(Cmd, "@DotacionPro", SqlDbType.VarChar, "N")
...
#Region "Cancelar Despachos"
    ...
    Public Shared Function fn_CancelarDespacho_LlenarLista(ByVal lsv As cp_Listview, ByVal Tipo As Integer, Status As String, Finicio As Date, Ffin As Date) As Boolean

        Try
            Dim cmd As SqlClient.SqlCommand = Crea_Comando("Bo_Despacho_GetPrueba", CommandType.StoredProcedure, Crea_ConexionSTD)
            'Dim cmd As SqlClient.SqlCommand = Crea_Comando("Bo_Despacho_Get", CommandType.StoredProcedure, Crea_ConexionSTD)
            Cn_Datos.Crea_Parametro(cmd, "@Id_Sucursal", SqlDbType.Int, SucursalId)
            Cn_Datos.Crea_Parametro(cmd, "@FDesde", SqlDbType.Date, Finicio)
            Cn_Datos.Crea_Parametro(cmd, "@FHasta", SqlDbType.Date, Ffin)
            Cn_Datos.Crea_Parametro(cmd, "@Tipo", SqlDbType.Int, Tipo)
            Cn_Datos.Crea_Parametro(cmd, "@Status", SqlDbType.VarChar, Status)
            Cn_Datos.Crea_Parametro(cmd, "@Dpto_Despacho", SqlDbType.VarChar, BovedaTipo)
    ...
    Public Shared Function fn_CancelarDespacho_Manual(ByVal Id_Despacho As Integer, ByVal Interno As Boolean, ByVal Pendiente As Boolean) As Boolean
        ...
        Return True
    End Function
    Public Shared Function fn_CancelarDespacho_Individual(ByVal Id_Despacho As Integer, ByVal Id_Remision As Integer, ByVal Interno As Boolean, ByVal Pendiente As Boolean) As Boolean
        Dim Cnn As SqlClient.SqlConnection
        Dim Tr As SqlClient.SqlTransaction
        Dim Cantidad As Integer = 0
        Try
            ...
            If Interno And Not Pendiente Then
                'Si es un Despacho de Rutas propias y el despacho ya no está como Pendiente
                'Eliminar las Remisiones de los Puntos en Ruta
                Dim cmd As SqlClient.SqlCommand = Crea_Comando("Bo_Despacho_CancelarPuntos_Individual", CommandType.StoredProcedure, Crea_ConexionSTD)
                Crea_Parametro(cmd, "@Id_Despacho", SqlDbType.Int, Id_Despacho)
                Crea_Parametro(cmd, "@Id_Remision", SqlDbType.Int, Id_Remision)
                Crea_Parametro(cmd, "@Usuario_Cancela", SqlDbType.Int, UsuarioId)
                Crea_Parametro(cmd, "@Estacion_Cancela", SqlDbType.VarChar, EstacioN)
...
#Region "Comprobar Remisión"
    ...
    Public Shared Function fn_ComprobarRemision_Update(ByVal Id_Remision As Integer, ByVal Id_Cia As Integer, ByVal Id_CiaProp As Integer,
                                                   ByVal Envases As Integer, ByVal EnvasesSN As Integer, ByVal Importe As Decimal,
...
#Region "Capturar Anomalías en Envases"
    ...
    Public Shared Function fn_AnomaliasEnvases_GuardarActa(ByVal Id_Remision As Integer, ByVal Id_Punto As Integer, ByVal Fecha_Acta As Date,
                                                           ByVal Hora_Acta As String, ByVal Numero_Esclusa As Integer, ByVal Id_Cliente As Integer,
...
#Region "Remisiones Rechazadas Rutas Externas"
    ...
    Public Shared Function fn_Guarada_RemisionesRechazadas(ByVal Id_Cia As Integer, ByVal NumeroRemision As Long, ByVal CantidadEnvases As Integer,
...
Validar:
    ...
    Public Shared Function fn_Bovedas_Catalogo_Nuevo(ByVal Clave As String, ByVal Descripcion As String, ByVal Apertura As String,
                                             ByVal Cierre As String, ByVal MonedaLR As Integer, ByVal ImporteLR _
    ...
    Public Shared Function fn_Bovedas_Catalogo_Actualizar(ByVal Id As Integer, ByVal Clave As String, ByVal Descripcion As String, ByVal Apertura As String,
                                             ByVal Cierre As String, ByVal MonedaLR As Integer, ByVal ImporteLR _
                                             As Integer, ByVal Tipo As Char) As Boolean
...
#Region "Remision digital"
    ...
    Public Shared Function fn_RecRutasPropiastvEnvases(ByVal lsv As cp_Listview, ByVal ID_programacion As Integer) As Boolean
        ...
        End Try
    End Function
    Public Shared Function fn_Mat_PuntosEnvases(ByVal lsv As cp_Listview, ByVal ID_programacion As Integer) As Boolean
        Try
            Dim Cnn As SqlClient.SqlConnection = Cn_Datos.Crea_ConexionSTD
            Dim Cmd As SqlClient.SqlCommand = Cn_Datos.Crea_Comando("Mat_Puntos_Envases", CommandType.StoredProcedure, Cnn)
            Cn_Datos.Crea_Parametro(Cmd, "@Id_Programacion", SqlDbType.Int, ID_programacion)
            lsv.Actualizar(Cmd, "")
            Return True
        Catch ex As Exception
    ...
    Public Shared Function fn_ListClientes() As DataTable
        ...
        End Try
    End Function
    Public Shared Function Mat_PuntosValidar(ByVal Id_programacion As Decimal, ByVal Id_Punto As Decimal, Id_Remision As Decimal) As Integer
        Dim Cnn As SqlConnection = Crea_ConexionSTD()
        Dim Cmd As SqlCommand = Crea_Comando("Mat_VentasValidar", CommandType.StoredProcedure, Cnn)
        Crea_Parametro(Cmd, "@Id_Programacion", SqlDbType.Decimal, Id_programacion)
        Crea_Parametro(Cmd, "@Id_Punto", SqlDbType.Decimal, Id_Punto)
        Crea_Parametro(Cmd, "@Id_UsuarioValida", SqlDbType.Decimal, UsuarioId)
        Crea_Parametro(Cmd, "@Id_Remision", SqlDbType.Decimal, Id_Remision)
        Try
            EjecutarNonQuery(Cmd)
            Return True
        Catch ex As Exception
...
#Region "Empleados que cancelan despachos"
    Public Shared Function fn_Lista_DespachosCancela_get() As DataTable
        Dim cnn As SqlConnection = Nothing
        Dim cmd As SqlCommand = Nothing

        Try
            cnn = Crea_ConexionSTD()
            cmd = Crea_Comando("Lista_DespachosCancela", CommandType.StoredProcedure, cnn)
            Return EjecutaConsulta(cmd)
        Catch ex As Exception
            cnn.Dispose()
            cmd.Dispose()
    ...
    Public Shared Function fn_AlertasGeneradas_ObtenerMails(ByVal Clave_AlertaTipo As String) As DataTable
        ...
        End Try
    End Function
    Public Shared Function fn_CancelarDespacho_LlenarLista(ByVal Tipo As Integer, Status As String, Finicio As Date, Ffin As Date, Depto As String) As DataTable
        ...
        Try
            ...
            Cn_Datos.Crea_Parametro(cmd, "@Tipo", SqlDbType.Int, Tipo)
            Cn_Datos.Crea_Parametro(cmd, "@Status", SqlDbType.VarChar, Status)
            Cn_Datos.Crea_Parametro(cmd, "@Dpto_Despacho", SqlDbType.VarChar, Depto)
        ...
        End Try
    End Function
    Public Shared Function fn_CancelarDespacho_LlenarDetalles(Finicio As Date, Ffin As Date) As DataTable
        Dim tbl As DataTable
        Try
            Dim cmd As SqlClient.SqlCommand = Crea_Comando("Bo_DespachoDReporte_Get", CommandType.StoredProcedure, Crea_ConexionSTD)
            Cn_Datos.Crea_Parametro(cmd, "@FDesde", SqlDbType.Date, Finicio)
            Cn_Datos.Crea_Parametro(cmd, "@FHasta", SqlDbType.Date, Ffin)
        ...
        End Try
    End Function
    Public Shared Function fn_CancelarDespacho_LlenarLista(ByVal lsv As cp_Listview, ByVal Tipo As Integer, Status As String, Finicio As Date, Ffin As Date, Depto As String) As Boolean
        ...
        End Try
    End Function
    Public Shared Function fn_ConsultaDespachos_Excel2(ByVal Desde As DateTime, ByVal Hasta As DateTime, Depto As String) As Boolean
        'Incluye los Folios de remisiones vendidas

        Dim Ventas As DataTable
        Dim VentasR As DataTable
        Dim Id_Venta As Integer = 0
        Dim j As Integer = 2

        'Traer las Ventas
        Ventas = fn_CancelarDespacho_LlenarLista(1, "C", Desde.Date, Hasta.Date, Depto)
        'Traer el detalle
        'Traer los folios de remisiones
        VentasR = fn_CancelarDespacho_LlenarDetalles(Desde.Date, Hasta.Date)
        ...
        With App
            ...
            .Range("B1").Value = "Hora"
            .Range("C1").Value = "Ruta"
            .Range("D1").Value = "Empleado"
            .Range("E1").Value = "ETV"

            .Range("F1").Value = "Remisiones"
            ' .Range("G1").Value = "Envases"
            .Range("G1").Value = "Cliente"

            Dim Fila_Anterior As Integer = 1 'para controlar el ciclo de las Ventas
            frm_MENU.prg_Barra.Value = 0
            frm_MENU.prg_Barra.Maximum = Ventas.Rows.Count + 2

            For Each FilaC As DataRow In Ventas.Rows
                frm_MENU.prg_Barra.Value += 1
                If Id_Venta = 0 Then
                    Id_Venta = FilaC.Item("Id_Despacho")
                ElseIf Id_Venta <> FilaC.Item("Id_Despacho") Then
                    Id_Venta = FilaC.Item("Id_Despacho")
                    j += 1
                End If
                .Range("A" & j).Value = FilaC.Item("Fecha")
                .Range("B" & j).Value = FilaC.Item("Hora")
                .Range("C" & j).Value = "'" & FilaC.Item("Ruta")
                .Range("D" & j).Value = FilaC.Item("Empleado")
                .Range("E" & j).Value = FilaC.Item("ETV")
                .Range("F" & j).Value = FilaC.Item("Remisiones")
                '.Range("G" & j).Value = FilaC.Item("Status")
                If Fila_Anterior <> j Then
                    Fila_Anterior = j
                    'Folios Remisiones
                    For Each FilaR As DataRow In VentasR.Rows
                        If FilaR.Item("Id_Despacho") = Id_Venta Then
                            j += 1
                            .Range("F" & j).Value = FilaR.Item("Remision")
                            .Range("G" & j).Value = FilaR.Item("Destino")
                            .Range("F" & j & ":G" & j).Font.Size = 8
                            .Range("F" & j & ":G" & j).Font.Italic = True
                        End If
                    Next
                End If
            ...
            .Range("A1:G" & j).BORDERS.VALUE = True
