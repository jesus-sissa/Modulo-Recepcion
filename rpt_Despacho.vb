...
Public Class rpt_Despacho
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Recepcion.rpt_Despacho.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Despacho
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Despacho = New rpt_Despacho()
        rpt.Site = Me.Site
        Return rpt
    End Function
