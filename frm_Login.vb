...
Public Class frm_Login
    ...
    Dim Msg As New ToolTip With {.BackColor = Color.OrangeRed, .InitialDelay = 200, .ToolTipIcon = ToolTipIcon.Info, .ToolTipTitle = "Mensaje del Administrador:", .UseAnimation = True, .UseFading = True}
    ...
    Private Sub frm_Login_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cmb_Boveda.AgregarItem("P", "PROCESO")
        cmb_Boveda.AgregarItem("C", "CAJEROS")
        ...
        If (Application.ApplicationDeployment.IsNetworkDeployed) Then
            ...
            lbl_Modulo.Text = "Módulo Recepción v" & String.Format("{0}", myVersion)
            ModuloVersion = String.Format("{0}", myVersion)
        Else
            lbl_Modulo.Text = "Módulo Recepción"
    ...
    Private Sub cmb_Boveda_KeyPress(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles cmb_Boveda.KeyPress
        If cmb_Boveda.SelectedValue = "0" Then
            MsgBox("Seleccione el Tipo de Bóveda que se va a operar.", MsgBoxStyle.Critical, frm_MENU.Text)
            cmb_Boveda.Focus()
            Exit Sub
        End If
        If Asc(e.KeyChar) = 13 Then
    ...
    Sub Validar()
        ...
        If cmb_Boveda.Visible Then
            If cmb_Boveda.SelectedValue.ToString.Trim = "0" Then
                MsgBox("Seleccione el Tipo de Bóveda que se va a operar.", MsgBoxStyle.Critical, frm_MENU.Text)
                cmb_Boveda.Focus()
                Exit Sub
            Else
                BovedaTipo = cmb_Boveda.SelectedValue
            End If
        End If
        ...
        Else
            ...
            MorrallaRecibeRuta = (DT.Rows(0)("Morralla_RecibeRutas") = "S")
