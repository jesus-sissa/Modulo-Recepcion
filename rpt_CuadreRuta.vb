...
Public Class rpt_CuadreRuta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Modulo_Recepcion.rpt_CuadreRuta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_CuadreRuta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_CuadreRuta = New rpt_CuadreRuta()
        rpt.Site = Me.Site
        Return rpt
    End Function
